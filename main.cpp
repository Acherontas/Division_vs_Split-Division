...
int main()
{
    ...
    cout<<"the 8 digits results tend to differ when we do the same process\n";
    cout<<"[ as process of '/' between two numbers]\n";
    ...
    if(exa==1){
      cout<<"using 8 digits\n";
      cout<<"initial result of 2785/33=84.393939\n";
      ...
      cout<<"results is 84.393938 and 603302\n";
      cout<<"so we have 84.393939 and 83.393938 xD \n";
    }
    if(exa==0){
    double rmlt;
    multi *mlt = new multi();
